...
This repository includes a ready workflow: `.github/workflows/deploy.yml`.

### How it works

1. Push to `main`
2. GitHub Actions builds with:
   - `npm ci`
   - `npm run build`
3. `dist/` is uploaded as Pages artifact
4. GitHub deploys to Pages environment
...
4. Push to `main` and wait for workflow success
...
Vite base is configured in `vite.config.ts`:
...
This makes project-page deployment work correctly without manual path edits.
